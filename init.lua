...
require('packer').startup(function(use)
  ...
  use { "tpope/vim-vinegar" }                                                       --  Enhances Netrw to have a project drawer style experience
...
-- Show the netrw banner which is hidden by vim-vinegar
vim.g.netrw_banner = 1
-- Show hide files in list
vim.g.netrw_hide = 0
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'lua', 'typescript', 'rust', 'go', 'python', 'solidity', 'ruby' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ft', vim.lsp.buf.formatting, '[f]ormat')
